...
IMG_SUBFOLDER = "image"
GT_SUBFOLDER = "label"
SPLIT_TRAIN_SUBFOLDER = "training"
SPLIT_VAL_SUBFOLDER = "validation"
...
SPLIT_TRAIN_IMG_PATH = os.path.join(SPLIT_PATH, SPLIT_TRAIN_SUBFOLDER, IMG_SUBFOLDER)
SPLIT_TRAIN_GT_PATH = os.path.join(SPLIT_PATH, SPLIT_TRAIN_SUBFOLDER, GT_SUBFOLDER)
SPLIT_VAL_IMG_PATH = os.path.join(SPLIT_PATH, SPLIT_VAL_SUBFOLDER, IMG_SUBFOLDER)
SPLIT_VAL_GT_PATH = os.path.join(SPLIT_PATH, SPLIT_VAL_SUBFOLDER, GT_SUBFOLDER)
