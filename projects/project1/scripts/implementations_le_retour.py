...
def _logistic_regression(y, tx, initial_w, max_iters, gamma, lambda_):
...
# Signatures for retrocompatibility
logistic_regression = lambda *p: _logistic_regression(*p, lambda_=0)
reg_logistic_regression = lambda *p: _logistic_regression(*p)
